...
import cls from "./schoolAbout.module.sass";

export const SchoolAbout = () => {
    return (
        <div className={cls.profile}>
            <div className={cls.card}>
                ...
                <div className={cls.footer}>
                    <p className={cls.footer__item}>Ta’lim tili <span>O’zbek</span></p>
                    <p className={cls.footer__item}>Ta’lim shakli <span>Kunduzgi</span></p>
                    <p className={cls.footer__item}>Ta’lim turi <span>Yoshlar 2-4 yil</span></p>
                </div>
            </div>
